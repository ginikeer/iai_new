...
<div class="wrap service_warp" id="service_main">
	...
	<div class="container">
		...
		<div class="color-white">
			...
			<div class="main_nav faq_nav">
				<ul class="topic_nav_block clear">
					<li class="active">
						<a href="javascript:;">F&Q</a>
					</li>
					<li>
						<a href="javascript:;">报警代码查询</a>
					</li>
				</ul>
			</div>
			...
			<div class="faq-content" style="display: none;">
				<table width="100%" class="faq-search">
					<tr>
						<th>报警代码</th>
						<td><input name="alarm-code" id="alarm-code" size="60"></td>
