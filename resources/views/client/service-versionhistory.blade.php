			...
			<div class="service-list-item">
				<div class="row row-no-offset">
					...
					<div class="col-lg-4 text-right">
						<a href="{{ url('service/history-download?l=CN&t=history&n=teaching&e=pdf') }}" target="_blank" class="btn btn-red btn-xs">点击下载</a>
					</div>
				</div>
				<div class="row row-no-offset">
					<div class="col-lg-8"><big>测试</big></div>
					<div class="col-lg-4 text-right">
						<a href="{{ url('service/history-download?l=CN&t=history&n=test&e=xlsx') }}" target="_blank" class="btn btn-red btn-xs">点击下载</a>
					</div>
				</div>
			</div>
		</div>
